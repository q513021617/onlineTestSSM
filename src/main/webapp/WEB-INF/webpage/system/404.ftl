...
<link href="${request.contextPath}/static/css/snow.css" rel="stylesheet" type="text/css" media="all" />
							...
							<!-- /login -->
							   <div class="over_lay_agile_pages_w3ls error">
								  <div class="registration error">
													 ...
													 <h6><a href="${request.contextPath}/Admin/">返回首页</a><h6>
												</div>
